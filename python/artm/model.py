...
class ARTM(object):
    ...
    def fit_offline(self, batch_vectorizer=None, num_collection_passes=20,
                    ...
                    ptdw_reg_tau=None, ptdw_reg_treshold=None, find_theta_ptdw=False):
        ...
        if find_theta_ptdw:
            ...
            theta_dataframe = DataFrame(data=array.transpose(), columns=document_ids, index=topic_names)
